...
android {
    namespace = "com.lagunalabs.swapigraphql"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.lagunalabs.swapigraphql"
        minSdk = 31
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
// Update schema by executing the following command at the root of the project:
...
apollo {
    service("swapi-graphql") {
        packageName.set("com.lagunalabs.swapi-graphql")
    }
}
